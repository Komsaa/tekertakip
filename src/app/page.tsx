          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="https://apps.apple.com/app/id6770069894"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2.5 border border-white/15 hover:border-white/30 hover:bg-white/5 text-white px-6 py-3.5 rounded-xl font-medium transition-all text-sm"
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              },
              {
                ...
                desc: "Her sofore kullanici adi ve sifre gonderin. iPhone icin App Store'dan \"TekerTakip\" uygulamasini indirip giris yapsinlar — bu kadar.",
              },
              {
                step: "3",
                icon: "🚀",
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-5 text-sm text-slate-500">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 bg-white/8 hover:bg-white/15 border border-white/10 text-slate-300 hover:text-white px-3 py-1.5 rounded-lg transition-all text-xs font-medium"
              >
