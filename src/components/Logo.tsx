...
export function LogoIcon({ size = 36, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      />
      {/* Sol üst kol */}
      <line x1="19" y1="19" x2="45" y2="45" stroke="#1B2437" strokeWidth="12" strokeLinecap="round" />
      {/* Sağ üst kol */}
      <line x1="81" y1="19" x2="55" y2="45" stroke="#1B2437" strokeWidth="12" strokeLinecap="round" />
      {/* Alt kol */}
      <line x1="50" y1="88" x2="50" y2="58" stroke="#1B2437" strokeWidth="12" strokeLinecap="round" />
      {/* GPS pin gövdesi */}
      <path
